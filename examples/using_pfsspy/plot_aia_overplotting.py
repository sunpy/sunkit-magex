...
###############################################################################
# Using the `~sunkit_magex.pfss.Input` object, plot the input photospheric magnetic field.
...
###############################################################################
# Now we construct a 5 x 5 grid of footpoints to trace some magnetic field
