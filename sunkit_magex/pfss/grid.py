...
class Grid:
    ...
    def __init__(self, ns: int, nphi: int, nr: int, rss: float):
        self.ns = ns
        self.nphi = nphi
        self.nr = nr
        self.rss = rss
    ...
    @property
    def rc(self) -> np.ndarray[tuple[int], np.dtype[np.float64]]:
        """
    ...
    @property
    def sc(self) -> np.ndarray[tuple[int], np.dtype[np.float64]]:
        """
    ...
    @property
    def pc(self) -> np.ndarray[tuple[int], np.dtype[np.float64]]:
        """
    ...
    @property
    def rg(self) -> np.ndarray[tuple[int], np.dtype[np.float64]]:
        """
    ...
    @property
    def sg(self) -> np.ndarray[tuple[int], np.dtype[np.float64]]:
        """
    ...
    @property
    def pg(self) -> np.ndarray[tuple[int], np.dtype[np.float64]]:
        """
